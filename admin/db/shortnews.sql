...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2020 at 06:29 PM
...
INSERT INTO `cities_list` (`city_id`, `city_name`) VALUES
(1, 'Lucknow'),
(2, 'Delhi');
...
--
-- Table structure for table `corona_cases`
--

CREATE TABLE `corona_cases` (
  `id` int(11) NOT NULL,
  `total_cases` varchar(20) NOT NULL,
  `total_discharged` varchar(20) NOT NULL,
  `total_deaths` varchar(20) NOT NULL,
  `total_active` varchar(20) NOT NULL,
  `updated_on` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `corona_cases`
--

INSERT INTO `corona_cases` (`id`, `total_cases`, `total_discharged`, `total_deaths`, `total_active`, `updated_on`) VALUES
(1, '4,11,700', '228,300', '13,280', '2,27,700', '2020-06-21');
...
(25, 6, 0, 'Ellie Goulding feeling \'broody\'', 'Los Angeles : Singer Ellie Goulding says she\'s feeling &quot;broody&quot; and has spoken about having children with her long-term boyfriend Dougie Poynter.', 'e3.jpg', 'tvnews', 'http://www.indiatvnews.com/entertainment/hollywood/ellie-goulding-feeling-broody-12078.html', '', '2015-10-20'),
(26, 6, 0, '20 years of \'DDLJ\': SRK, Kajol recreate \'DDLJ\' on \'Dilwale\' sets ', 'The 49-year-old actor and Kajol, 41, who are teaming up again for Rohit Shetty\'s &quot;Dilwale&quot;, marked the 20 years celebration by revisiting DDLJ\'s famous poster while shooting for the upcoming movie here.', 'e4.jpg', 'midday', 'http://www.mid-day.com/articles/20-years-of-ddlj-srk-kajol-recreate-ddlj-on-dilwale-sets/16621195', 'https://www.youtube.com/watch?v=xSmvMgAKeLs', '2015-10-20'),
...
--
-- Indexes for table `corona_cases`
--
ALTER TABLE `corona_cases`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `corona_cases`
--
ALTER TABLE `corona_cases`
...
--
ALTER TABLE `news`
  MODIFY `guide` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
COMMIT;
