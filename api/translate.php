...
echo $link = 'https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=ru&dt=t&q='.urlencode('Hello world');
// echo $test = Translate("My name is manoj", 'hi_to_en');
?>
